...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../anime-master/lib/anime.min.js */ \"./anime-master/lib/anime.min.js\");\n/* harmony import */ var _libs_dynamic_adapt_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./libs/dynamic_adapt.js */ \"./src/js/libs/dynamic_adapt.js\");\n/* harmony import */ var _modules_sliders_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/sliders.js */ \"./src/js/modules/sliders.js\");\n/* harmony import */ var _libs_functions_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./libs/functions.js */ \"./src/js/libs/functions.js\");\n\n\n\n\n\n\n\n//import { spollers } from \"./libs/functions.js\";\n//import \"./modules/tippy.js\";\n\nlet map = document.querySelector(\".surf-page__map\");\nlet buttons = document.querySelectorAll(\".surf-page__circle\");\nlet mainMap = document.querySelector(\".main-page__map\");\nlet mainMapArrows = document.querySelector(\".map-surf__navigation\");\nlet path = mainMap.querySelectorAll(\"svg path\");\nlet boardTips = document.querySelector(\".shop-slide__content\");\nlet search = document.querySelector(\".header__btn\");\nlet searchInput = document.querySelector(\".header__input\");\n\nlet menuSlider = document.querySelector(\".menu-slider\");\nlet menuWrapper = document.querySelector(\".menu-slider__wrapper\");\nlet menuSlides = document.querySelectorAll(\".menu-active\");\n\nmap.addEventListener(\"click\", buttonOpen);\nmainMapArrows.addEventListener(\"click\", pathChange)\nboardTips.addEventListener(\"click\", tipsOpen);\nsearch.addEventListener(\"click\", searchToggle);\n\n\nlet slideNumber = 2;\nlet slideNumberMax = mainMap.querySelectorAll(\".map-surf__svg\").length;\n\n\nfunction buttonOpen(e) {\n    if (!e.target.classList.contains(\"surf-page__circle-active\") && !e.target.closest(\".surf-page__active-menu\")) {\n            if (e.target.classList.contains(\"surf-page__circle\")) {\n                buttons.forEach(element => {\n                    element.classList.remove(\"surf-page__circle-active\")\n                }\n                )\n                e.target.classList.add('surf-page__circle-active');\n            }\n        };\n}\nfunction pathChange(e) {\n    if (e.target.closest(\".map-surf__arrow-prev\") && slideNumber > 1) {\n        slideNumber -=1;\n        mainMap.classList.remove(`map-surf__slide-${slideNumber + 1}`)\n        mainMap.classList.add(`map-surf__slide-${slideNumber}`)\n        _anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__(\n            {\n                targets: path,\n                duration: 2000,\n                delay: 0,\n                easing: 'easeInOutExpo',\n                strokeDashoffset: [_anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__.setDashoffset, 0]\n            }\n        )\n    }\n    if (e.target.closest(\".map-surf__arrow-next\") && slideNumber < slideNumberMax) {\n        slideNumber +=1;\n        mainMap.classList.remove(`map-surf__slide-${slideNumber - 1}`)\n        mainMap.classList.add(`map-surf__slide-${slideNumber}`)\n        _anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__(\n            {\n                targets: path,\n                duration: 2000,\n                delay: 0,\n                easing: 'easeInOutExpo',\n                strokeDashoffset: [_anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__.setDashoffset, 0]\n            }\n        )\n    }\n}\nfunction tipsOpen(e) {\n    console.log(e.target.offsetParent);\n    if (e.target.classList.contains(\"tip__sign\")) {\n        e.target.offsetParent.classList.toggle(\"tip-active\");\n    }\n}\nfunction searchToggle(e) {\n    searchInput.value = \"\";\n    e.target.offsetParent.classList.toggle(\"header__search-active\");\n}\nfunction mediaJS() {\n    let mediaCondition = window.matchMedia(\"(max-width: 509.98px)\").matches;\n    if(mediaCondition && !menuSlider.classList.contains(\"swiper\")){\n        menuSlider.classList.add(\"swiper\");\n        //menuSlider.classList.add(\"items-slider\");\n        menuWrapper.classList.add(\"swiper-wrapper\");\n        for (let index = 0; index < menuSlides.length; index++) {\n            menuSlides[index].classList.add(\"swiper-slide\");\n        }\n        (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_2__.initOptionalSlider)();   \n    }\n    else if(!mediaCondition && menuSlider.classList.contains(\"swiper\")){\n            menuSlider.classList.remove(\"swiper\", \"items-slider\", \"swiper-initialized\", \"swiper-horizontal\", \"swiper-android\", \"swiper-backface-hidden\");\n            menuSlider.removeAttribute(\"style\");\n            menuWrapper.classList.remove(\"swiper-wrapper\");\n            menuWrapper.removeAttribute(\"style\");\n            for (let index = 0; index < menuSlides.length; index++) {\n                menuSlides[index].classList.remove(\"swiper-slide\", \"swiper-slide-active\", \"swiper-slide-next\", \"swiper-slide-prev\");\n                menuSlides[index].removeAttribute(\"style\");\n            }\n    }\n}\n\nsetInterval(mediaJS, 10);\n\n\n_anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__(\n    {\n        targets: path,\n        duration: 2000,\n        delay: 0,\n        easing: 'easeInOutExpo',\n        strokeDashoffset: [_anime_master_lib_anime_min_js__WEBPACK_IMPORTED_MODULE_0__.setDashoffset, 0]\n    }\n)\n\n\n\n\n\n\n\n// function buttonOpen(e) {\n//     if (!e.target.classList.contains(\"surf-page__circle-active\") && !e.target.closest(\".surf-page__active-menu\")) {\n//         buttons.forEach(element => {\n//             element.classList.remove(\"surf-page__circle-active\")\n//             if (element == e.target) {\n//                 element.classList.add('surf-page__circle-active');\n//             }\n//         });\n//     }\n// }\n\n//# sourceURL=webpack://rock/./src/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   initOptionalSlider: () => (/* binding */ initOptionalSlider)\n/* harmony export */ });\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n/*\r\nДокументация по работе в шаблоне: \r\nДокументация слайдера: https://swiperjs.com/\r\nСниппет(HTML): swiper\r\n*/\r\n\r\n// Подключаем слайдер Swiper из node_modules\r\n// При необходимости подключаем дополнительные модули слайдера, указывая их в {} через запятую\r\n// Пример: { Navigation, Autoplay }\r\n\r\n\r\n\r\n/*\r\nОсновниые модули слайдера:\r\nNavigation, Pagination, Autoplay, \r\nEffectFade, Lazy, Manipulation\r\nПодробнее смотри https://swiperjs.com/\r\n*/\r\n\r\n// Стили Swiper\r\n// Базовые стили\r\n\r\n//import \"../../scss/base/swiper.scss\";\r\n\r\n// Полный набор стилей из scss/libs/swiper.scss\r\n// import \"../../scss/libs/swiper.scss\";\r\n// Полный набор стилей из node_modules\r\n// import 'swiper/css';\r\n\r\n\r\nlet bullets = document.querySelectorAll(\".main-page__dot-block\");\r\n\r\n\r\n// Инициализация слайдеров\r\nfunction initSliders() {\r\n\t// Перечень слайдеров\r\n\t// Проверяем, есть ли слайдер на стронице\r\n\tif (document.querySelector('.main-page__slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.main-page__slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\tobserver: true,\r\n\t\t\tobserveParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 30,\r\n\t\t\t//autoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t//parallax: true,\r\n\t\t\t\r\n\t\t\t//Эффекты\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 3000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\t// pagination: {\r\n\t\t\t// \tel: '.main-page__dots',\r\n\t\t\t// \tclickable: true,\r\n\t\t\t// \tbulletElement: \"div\",\r\n\t\t\t// \trenderBullet: function (index, className) {\r\n\t\t\t// \t\t    return '<div class=\"' + className + ' ' + className + \"_\" + index +' \">' + \"<div class=\\\"dots-block__number\\\">\" + (\"0\" + (index + 1)) + \"</div>\" + \"<div class=\\\"dots-block__name\\\"></div>\" + '</div>';\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t// Кнопки \"влево/вправо\"\r\n\t\t\tnavigation: {\r\n\t\t\t\tprevEl: '.swiper-button-prev',\r\n\t\t\t\tnextEl: '.swiper-button-next',\r\n\t\t\t},\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t//  breakpoints: {\r\n\t\t\t//  \t320: {\r\n\t\t\t//  \t\tslidesPerView: 1,\r\n\t\t\t//  \t\tspaceBetween: 10,\r\n\t\t\t// \t\t//autoHeight: true,\r\n\t\t\t//  \t},\r\n\t\t\t//  \t500: {\r\n\t\t\t//  \t\tslidesPerView: 2,\r\n\t\t\t//  \t\tspaceBetween: 20,\r\n\t\t\t//  \t},\r\n\t\t\t// \t992: {\r\n\t\t\t//  \t\tslidesPerView: 3,\r\n\t\t \t// \t\tspaceBetween: 30,\r\n\t\t\t//  \t},\r\n\t\t\t// \t1600: {\r\n\t\t\t//  \t\tslidesPerView: 4,\r\n\t\t\t//  \t\tspaceBetween: 40,\r\n\t\t\t// \t},\r\n\t\t\t//  },\r\n\t\t\t\r\n\t\t\t// События\r\n\r\n\t\t\t on: {\r\n\t\t\t\tclick: function name(params) {\r\n\t\t\t\t\tswiper.realIndex = 1;\r\n\t\t\t\t\tswiper.activeIndex = 1;\t\r\n\t\t\t\t},\r\n\t\t\t\tslideChange: function (swiper) {\r\n\t\t\t\t\tswitch (swiper.realIndex) {\r\n\t\t\t\t\t\tcase 0:\r\n\t\t\t\t\t\t\tswiper.realIndex = 3;\r\n\t\t\t\t\t\t\tbullets.forEach(element => {\r\n\t\t\t\t\t\t\t\telement.classList.remove(\"block-dot-active\");\t\r\n\t\t\t\t\t\t\t});\r\n\t\t\t\t\t\t\tbullets[0].classList.add(\"block-dot-active\");\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 1:\r\n\t\t\t\t\t\t\tbullets.forEach(element => {\r\n\t\t\t\t\t\t\t\telement.classList.remove(\"block-dot-active\");\t\r\n\t\t\t\t\t\t\t});\r\n\t\t\t\t\t\t\tbullets[1].classList.add(\"block-dot-active\");\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 2:\r\n\t\t\t\t\t\t\tbullets.forEach(element => {\r\n\t\t\t\t\t\t\t\telement.classList.remove(\"block-dot-active\");\t\r\n\t\t\t\t\t\t\t});\r\n\t\t\t\t\t\t\tbullets[2].classList.add(\"block-dot-active\");\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 3:\r\n\t\t\t\t\t\t\tbullets.forEach(element => {\r\n\t\t\t\t\t\t\telement.classList.remove(\"block-dot-active\");\t\r\n\t\t\t\t\t\t\t});\r\n\t\t\t\t\t\t\tbullets[3].classList.add(\"block-dot-active\");\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 4:\r\n\t\t\t\t\t\t\tbullets.forEach(element => {\r\n\t\t\t\t\t\t\telement.classList.remove(\"block-dot-active\");\t\r\n\t\t\t\t\t\t\t});\r\n\t\t\t\t\t\t\tbullets[4].classList.add(\"block-dot-active\");\r\n\t\t\t\t\t\t\tbreak;\t\r\n\t\t\t\t\t\tdefault:\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\r\n\t\t\t\t// init: function (swiper) {\r\n\t\t\t\t// \tconst allSlides = document.querySelector(\".fraction-controll__all\");\r\n\t\t\t\t// \tconst allSlidesItems = document.querySelectorAll(\".main-block__slide:not(.swiper-slide-duplicate)\");\r\n\t\t\t\t// \tallSlides.innerHTML = allSlidesItems.length < 10 ? `0${allSlidesItems.length}` : allSlidesItems.length;\r\n\t\t\t\t// },\r\n\t\t\t\t// slideChange: function (swiper) {\r\n\t\t\t\t// \tconst currentSlide = document.querySelector(\".fraction-controll__current\");\r\n\t\t\t\t// \tcurrentSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : swiper.realIndex + 1 ;\r\n\t\t\t\t// \tconsole.log(swiper);\r\n\t\t\t\t// }\r\n\t\t \t}\r\n\t\t});\r\n\t}\r\n\tif (document.querySelector('.surf-page__slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.surf-page__slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\tobserver: true,\r\n\t\t\tobserveParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 40,\r\n\t\t\t//autoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\twatchOverflow: true,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t// Эффекты\r\n\t\t\t//effect: 'fade',\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 3000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\t// pagination: {\r\n\t\t\t// \tel: '.controll-knife-slider__dots',\r\n\t\t\t// \tclickable: true,\r\n\t\t\t// \tdynamicBullets: true\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t//Кнопки \"влево/вправо\"\r\n\t\t\tnavigation: {\r\n\t\t\t\tprevEl: '.surf-page__prev-btn',\r\n\t\t\t\tnextEl: '.surf-page__next-btn',\r\n\t\t\t},\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t// breakpoints: {\r\n\t\t\t// \t320: {\r\n\t\t\t// \t\tslidesPerView: 1,\r\n\t\t\t// \t\tspaceBetween: 10,\r\n\t\t\t// \t},\r\n\t\t\t// \t768: {\r\n\t\t\t// \t\tslidesPerView: 2,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t992: {\r\n\t\t\t// \t\tslidesPerView: 3,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t1370: {\r\n\t\t\t// \t\tslidesPerView: 4,\r\n\t\t\t// \t\tspaceBetween: 30,\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\t\t\t// События\r\n\t\t\t// on: {\r\n\t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n\t\t\t// \t// }\r\n\t\t\t// }\r\n\t\t});\r\n\t}\r\n\tif (document.querySelector('.travel-page__slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.travel-page__slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\tobserver: true,\r\n\t\t\tobserveParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 80,\r\n\t\t\tautoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\twatchOverflow: true,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t// Эффекты\r\n\t\t\t//effect: 'fade',\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 3000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\t// pagination: {\r\n\t\t\t// \tel: '.controll-knife-slider__dots',\r\n\t\t\t// \tclickable: true,\r\n\t\t\t// \tdynamicBullets: true\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t//Кнопки \"влево/вправо\"\r\n\t\t\tnavigation: {\r\n\t\t\t\tprevEl: '.travel-page__prev-btn',\r\n\t\t\t\tnextEl: '.travel-page__next-btn',\r\n\t\t\t},\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t// breakpoints: {\r\n\t\t\t// \t320: {\r\n\t\t\t// \t\tslidesPerView: 1,\r\n\t\t\t// \t\tspaceBetween: 10,\r\n\t\t\t// \t},\r\n\t\t\t// \t768: {\r\n\t\t\t// \t\tslidesPerView: 2,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t992: {\r\n\t\t\t// \t\tslidesPerView: 3,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t1370: {\r\n\t\t\t// \t\tslidesPerView: 4,\r\n\t\t\t// \t\tspaceBetween: 30,\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\t\t\t// События\r\n\t\t\t// on: {\r\n\t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n\t\t\t// \t// }\r\n\t\t\t// }\r\n\t\t});\r\n\t}\r\n\tif (document.querySelector('.sleep-page__slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.sleep-page__slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\tobserver: true,\r\n\t\t\tobserveParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 80,\r\n\t\t\tautoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\twatchOverflow: true,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t// Эффекты\r\n\t\t\t//effect: 'fade',\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 3000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\t// pagination: {\r\n\t\t\t// \tel: '.controll-knife-slider__dots',\r\n\t\t\t// \tclickable: true,\r\n\t\t\t// \tdynamicBullets: true\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t//Кнопки \"влево/вправо\"\r\n\t\t\tnavigation: {\r\n\t\t\t\tprevEl: '.sleep-page__prev-btn',\r\n\t\t\t\tnextEl: '.sleep-page__next-btn',\r\n\t\t\t},\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t// breakpoints: {\r\n\t\t\t// \t320: {\r\n\t\t\t// \t\tslidesPerView: 1,\r\n\t\t\t// \t\tspaceBetween: 10,\r\n\t\t\t// \t},\r\n\t\t\t// \t768: {\r\n\t\t\t// \t\tslidesPerView: 2,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t992: {\r\n\t\t\t// \t\tslidesPerView: 3,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t1370: {\r\n\t\t\t// \t\tslidesPerView: 4,\r\n\t\t\t// \t\tspaceBetween: 30,\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\t\t\t// События\r\n\t\t\t// on: {\r\n\t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n\t\t\t// \t// }\r\n\t\t\t// }\r\n\t\t});\r\n\t}\r\n\tif (document.querySelector('.shop-page__slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.shop-page__slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\tobserver: true,\r\n\t\t\tobserveParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 80,\r\n\t\t\t//autoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\twatchOverflow: true,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t// Эффекты\r\n\t\t\t//effect: 'fade',\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 3000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\t// pagination: {\r\n\t\t\t// \tel: '.controll-knife-slider__dots',\r\n\t\t\t// \tclickable: true,\r\n\t\t\t// \tdynamicBullets: true\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t//Кнопки \"влево/вправо\"\r\n\t\t\tnavigation: {\r\n\t\t\t\tprevEl: '.shop-page__prev-btn',\r\n\t\t\t\tnextEl: '.shop-page__next-btn',\r\n\t\t\t},\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t// breakpoints: {\r\n\t\t\t// \t320: {\r\n\t\t\t// \t\tslidesPerView: 1,\r\n\t\t\t// \t\tspaceBetween: 10,\r\n\t\t\t// \t},\r\n\t\t\t// \t768: {\r\n\t\t\t// \t\tslidesPerView: 2,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t992: {\r\n\t\t\t// \t\tslidesPerView: 3,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t1370: {\r\n\t\t\t// \t\tslidesPerView: 4,\r\n\t\t\t// \t\tspaceBetween: 30,\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\t\t\t// События\r\n\t\t\t// on: {\r\n\t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n\t\t\t// \t// }\r\n\t\t\t// }\r\n\t\t});\r\n\t}\r\n\tif (document.querySelector('.surf-grid__slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.surf-grid__slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\tobserver: true,\r\n\t\t\tobserveParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 80,\r\n\t\t\t//autoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\twatchOverflow: true,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t// Эффекты\r\n\t\t\t//effect: 'fade',\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 3000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\t// pagination: {\r\n\t\t\t// \tel: '.controll-knife-slider__dots',\r\n\t\t\t// \tclickable: true,\r\n\t\t\t// \tdynamicBullets: true\r\n\t\t\t// },\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t//Кнопки \"влево/вправо\"\r\n\t\t\tnavigation: {\r\n\t\t\t\tprevEl: '.shop-page__prev-btn',\r\n\t\t\t\tnextEl: '.shop-page__next-btn',\r\n\t\t\t},\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t// breakpoints: {\r\n\t\t\t// \t320: {\r\n\t\t\t// \t\tslidesPerView: 1,\r\n\t\t\t// \t\tspaceBetween: 10,\r\n\t\t\t// \t},\r\n\t\t\t// \t768: {\r\n\t\t\t// \t\tslidesPerView: 2,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t992: {\r\n\t\t\t// \t\tslidesPerView: 3,\r\n\t\t\t// \t\tspaceBetween: 20,\r\n\t\t\t// \t},\r\n\t\t\t// \t1370: {\r\n\t\t\t// \t\tslidesPerView: 4,\r\n\t\t\t// \t\tspaceBetween: 30,\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\t\t\t// События\r\n\t\t\t// on: {\r\n\t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n\t\t\t// \t// }\r\n\t\t\t// }\r\n\t\t});\r\n\t}\r\n\t// if (document.querySelector('.new-block__slider')) { // Указываем скласс нужного слайдера\r\n\t// \t// Создаем слайдер\r\n\t// \tconst swiper = new Swiper('.new-block__slider', { // Указываем скласс нужного слайдера\r\n\t// \t\t// Подключаем модули слайдера\r\n\t// \t\t// для конкретного случая\r\n\t// \t\tmodules: [Navigation, Pagination, Parallax, Autoplay],\r\n\t// \t\tobserver: true,\r\n\t// \t\tobserveParents: true,\r\n\t// \t\tslidesPerView: 3,\r\n\t// \t\tspaceBetween: 30,\r\n\t// \t\t//autoHeight: true,\r\n\t// \t\tspeed: 800,\r\n\r\n\t// \t\t//touchRatio: 0,\r\n\t// \t\t//simulateTouch: false,\r\n\t// \t\tloop: true,\r\n\t// \t\t//preloadImages: false,\r\n\t// \t\t//lazy: true,\r\n\t// \t\t// parallax: true,\r\n\t\t\t\r\n\t// \t\t// Эффекты\r\n\t// \t\t//effect: 'fade',\r\n\t// \t\tautoplay: {\r\n\t// \t\t\tdelay: 3000,\r\n\t// \t\t\tdisableOnInteraction: false,\r\n\t// \t\t},\r\n\t\t\t\r\n\r\n\t// \t\t// Пагинация\r\n\t\t\t\r\n\t// \t\tpagination: {\r\n\t// \t\t\tel: '.controll-new-block__dots',\r\n\t// \t\t\tclickable: true,\r\n\t// \t\t},\r\n\t\t\t\r\n\r\n\t// \t\t// Скроллбар\r\n\t// \t\t/*\r\n\t// \t\tscrollbar: {\r\n\t// \t\t\tel: '.swiper-scrollbar',\r\n\t// \t\t\tdraggable: true,\r\n\t// \t\t},\r\n\t// \t\t*/\r\n\r\n\t// \t\t// Кнопки \"влево/вправо\"\r\n\t// \t\t// navigation: {\r\n\t// \t\t// \tprevEl: '.swiper-button-prev',\r\n\t// \t\t// \tnextEl: '.swiper-button-next',\r\n\t// \t\t// },\r\n\r\n\t// \t\t// Брейкпоинты\r\n\t\t\t\r\n\t// \t\tbreakpoints: {\r\n\t// \t\t\t320: {\r\n\t// \t\t\t\tslidesPerView: 1,\r\n\t// \t\t\t\tspaceBetween: 10,\r\n\t// \t\t\t\t// autoHeight: true,\r\n\t// \t\t\t},\r\n\t// \t\t\t768: {\r\n\t// \t\t\t\tslidesPerView: 1,\r\n\t// \t\t\t\tspaceBetween: 20,\r\n\t// \t\t\t},\r\n\t// \t\t\t1120: {\r\n\t// \t\t\t\tslidesPerView: 1,\r\n\t// \t\t\t\tspaceBetween: 20,\r\n\t// \t\t\t},\r\n\t// \t\t\t1490: {\r\n\t// \t\t\t\tslidesPerView: 3,\r\n\t// \t\t\t\tspaceBetween: 30,\r\n\t// \t\t\t},\r\n\t// \t\t},\r\n\t\t\t\r\n\t// \t\t// События\r\n\t// \t\ton: {\r\n\t\t\t\t\r\n\t// \t\t}\r\n\t// \t});\r\n\t// }\r\n\r\n\t// if (document.querySelector('.thumbs-images')) { // Указываем скласс нужного слайдера\r\n\t// \t// Создаем слайдер\r\n\t// \tconst thumbsSwiper = new Swiper('.thumbs-images', { // Указываем скласс нужного слайдера\r\n\t// \t\t// Подключаем модули слайдера\r\n\t// \t\t// для конкретного случая\r\n\t// \t\tmodules: [Navigation, Pagination, Parallax, Autoplay, Thumbs],\r\n\t// \t\tobserver: true,\r\n\t// \t\tobserveParents: true,\r\n\t// \t\tslidesPerView: 3,\r\n\t// \t\tspaceBetween: 30,\r\n\t// \t\t//autoHeight: true,\r\n\t// \t\tspeed: 800,\r\n\r\n\t// \t\t//touchRatio: 0,\r\n\t// \t\t//simulateTouch: false,\r\n\t// \t\tloop: true,\r\n\t// \t\t//preloadImages: false,\r\n\t// \t\t//lazy: true,\r\n\t// \t\t// parallax: true,\r\n\t\t\t\r\n\t// \t\t// Эффекты\r\n\t// \t\t//effect: 'fade',\r\n\r\n\t// \t\t// Пагинация\r\n\t\t\t\r\n\t// \t\tpagination: {\r\n\t// \t\t\tel: '.products-new__dotts',\r\n\t// \t\t\tclickable: true,\r\n\t// \t\t},\r\n\t\t\t\r\n\r\n\t// \t\t// Скроллбар\r\n\t// \t\t/*\r\n\t// \t\tscrollbar: {\r\n\t// \t\t\tel: '.swiper-scrollbar',\r\n\t// \t\t\tdraggable: true,\r\n\t// \t\t},\r\n\t// \t\t*/\r\n\r\n\t// \t\t// Кнопки \"влево/вправо\"\r\n\t// \t\t// navigation: {\r\n\t// \t\t// \tprevEl: '.swiper-button-prev',\r\n\t// \t\t// \tnextEl: '.swiper-button-next',\r\n\t// \t\t// },\r\n\r\n\t// \t\t// Брейкпоинты\r\n\t\t\t\r\n\t// \t\tbreakpoints: {\r\n\t// \t\t\t320: {\r\n\t// \t\t\t\tslidesPerView: 1,\r\n\t// \t\t\t\tspaceBetween: 10,\r\n\t// \t\t\t\t// autoHeight: true,\r\n\t// \t\t\t},\r\n\t// \t\t\t768: {\r\n\t// \t\t\t\tslidesPerView: 2,\r\n\t// \t\t\t\tspaceBetween: 20,\r\n\t// \t\t\t},\r\n\t// \t\t\t992: {\r\n\t// \t\t\t\tslidesPerView: 2,\r\n\t// \t\t\t\tspaceBetween: 20,\r\n\t// \t\t\t},\r\n\t// \t\t\t1330: {\r\n\t// \t\t\t\tslidesPerView: 4,\r\n\t// \t\t\t\tspaceBetween: 30,\r\n\t// \t\t\t},\r\n\t// \t\t},\r\n\t\t\t\r\n\t// \t\t// События\r\n\t// \t\ton: {\r\n\t\t\t\t\r\n\t// \t\t}\r\n\r\n\t\t\t\r\n\t// \t});\r\n\t// \tconst swiper = new Swiper('.images-product__slider', { // Указываем скласс нужного слайдера\r\n\t// \t\t// Подключаем модули слайдера\r\n\t// \t\t// для конкретного случая\r\n\t// \t\tmodules: [Navigation, Pagination, Parallax, Autoplay, Thumbs],\r\n\t// \t\tobserver: true,\r\n\t// \t\tobserveParents: true,\r\n\t// \t\tslidesPerView: 1,\r\n\t// \t\tspaceBetween: 16,\r\n\t// \t\t//autoHeight: true,\r\n\t// \t\tspeed: 800,\r\n\r\n\t// \t\t//touchRatio: 0,\r\n\t// \t\t//simulateTouch: false,\r\n\t// \t\tloop: true,\r\n\t// \t\t//preloadImages: false,\r\n\t// \t\t//lazy: true,\r\n\t// \t\t// parallax: true,\r\n\t\t\t\r\n\t// \t\t// Эффекты\r\n\t// \t\t//effect: 'fade',\r\n\t// \t\tautoplay: {\r\n\t// \t\t\tdelay: 3000,\r\n\t// \t\t\tdisableOnInteraction: false,\r\n\t// \t\t},\r\n\t// \t\tthumbs:{\r\n\t// \t\t\tswiper: thumbsSwiper,\r\n\t// \t\t},\r\n\r\n\t// \t\t// Пагинация\r\n\t\t\t\r\n\t// \t\t// pagination: {\r\n\t// \t\t// \tel: '.products-new__dotts',\r\n\t// \t\t// \tclickable: true,\r\n\t// \t\t// },\r\n\t\t\t\r\n\r\n\t// \t\t// Скроллбар\r\n\t// \t\t/*\r\n\t// \t\tscrollbar: {\r\n\t// \t\t\tel: '.swiper-scrollbar',\r\n\t// \t\t\tdraggable: true,\r\n\t// \t\t},\r\n\t// \t\t*/\r\n\r\n\t// \t\t// Кнопки \"влево/вправо\"\r\n\t// \t\t// navigation: {\r\n\t// \t\t// \tprevEl: '.swiper-button-prev',\r\n\t// \t\t// \tnextEl: '.swiper-button-next',\r\n\t// \t\t// },\r\n\r\n\t// \t\t// Брейкпоинты\r\n\t\t\t\r\n\t// \t\t// breakpoints: {\r\n\t// \t\t// \t320: {\r\n\t// \t\t// \t\tslidesPerView: 1,\r\n\t// \t\t// \t\tspaceBetween: 10,\r\n\t// \t\t// \t\t// autoHeight: true,\r\n\t// \t\t// \t},\r\n\t// \t\t// \t768: {\r\n\t// \t\t// \t\tslidesPerView: 2,\r\n\t// \t\t// \t\tspaceBetween: 20,\r\n\t// \t\t// \t},\r\n\t// \t\t// \t992: {\r\n\t// \t\t// \t\tslidesPerView: 2,\r\n\t// \t\t// \t\tspaceBetween: 20,\r\n\t// \t\t// \t},\r\n\t// \t\t// \t1330: {\r\n\t// \t\t// \t\tslidesPerView: 3,\r\n\t// \t\t// \t\tspaceBetween: 30,\r\n\t// \t\t// \t},\r\n\t// \t\t// },\r\n\t\t\t\r\n\t// \t\t// События\r\n\t// \t\ton: {\r\n\t\t\t\t\r\n\t// \t\t}\r\n\t// \t});\r\n\t// }\r\n}\r\nfunction initOptionalSlider() {\r\n\tif (document.querySelector('.menu-slider')) { // Указываем скласс нужного слайдера\r\n\t\t// Создаем слайдер\r\n\t\tconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.menu-slider', { // Указываем скласс нужного слайдера\r\n\t\t\t// Подключаем модули слайдера\r\n\t\t\t// для конкретного случая\r\n\t\t\tmodules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\r\n\t\t\t//observer: true,\r\n\t\t\t//observeParents: true,\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 30,\r\n\t\t\t//autoHeight: true,\r\n\t\t\tspeed: 800,\r\n\t\t\twatchOverflow: true,\r\n\t\t\t//touchRatio: 0,\r\n\t\t\t//simulateTouch: false,\r\n\t\t\tloop: true,\r\n\t\t\t//preloadImages: false,\r\n\t\t\t//lazy: true,\r\n\t\t\t// Эффекты\r\n\t\t\t//effect: 'fade',\r\n\t\t\t// autoplay: {\r\n\t\t\t// \tdelay: 6000,\r\n\t\t\t// \tdisableOnInteraction: false,\r\n\t\t\t// },\r\n\t\t\t// Пагинация\r\n\t\t\t\r\n\t\t\tpagination: {\r\n\t\t\t\tel: '.menu-slider__dots',\r\n\t\t\t\tclickable: true,\r\n\t\t\t\t//dynamicBullets: true\r\n\t\t\t},\r\n\t\t\t\r\n\r\n\t\t\t// Скроллбар\r\n\t\t\t/*\r\n\t\t\tscrollbar: {\r\n\t\t\t\tel: '.swiper-scrollbar',\r\n\t\t\t\tdraggable: true,\r\n\t\t\t},\r\n\t\t\t*/\r\n\r\n\t\t\t// Кнопки \"влево/вправо\"\r\n\t\t\t// navigation: {\r\n\t\t\t// \tprevEl: '.swiper-button-prev',\r\n\t\t\t// \tnextEl: '.swiper-button-next',\r\n\t\t\t// },\r\n\r\n\t\t\t// Брейкпоинты\r\n\t\t\t\r\n\t\t\t// breakpoints: {\r\n\t\t\t// \t320: {\r\n\t\t\t// \t\tslidesPerView: 1,\r\n\t\t\t// \t\tspaceBetween: 70,\r\n\t\t\t// \t},\r\n\t\t\t// \t// 768: {\r\n\t\t\t// \t// \tslidesPerView: 2,\r\n\t\t\t// \t// \tspaceBetween: 20,\r\n\t\t\t// \t// },\r\n\t\t\t// \t// 500: {\r\n\t\t\t// \t// \tslidesPerView: 3,\r\n\t\t\t// \t// \tspaceBetween: 20,\r\n\t\t\t// \t// },\r\n\t\t\t// \t1075: {\r\n\t\t\t// \t\tslidesPerView: 2,\r\n\t\t\t// \t\tspaceBetween: 30,\r\n\t\t\t// \t},\r\n\t\t\t// },\r\n\t\t\t\r\n\t\t\t// События\r\n\t\t\t// on: {\r\n\t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n\t\t\t// \t// }\r\n\t\t\t// }\r\n\t\t});\r\n\t}\r\n}\r\n\r\n// function initOptionalSlider() {\r\n// \tif (document.querySelector('.items-slider')) { // Указываем скласс нужного слайдера\r\n// \t\t// Создаем слайдер\r\n// \t\tconst swiper = new Swiper('.items-slider', { // Указываем скласс нужного слайдера\r\n// \t\t\t// Подключаем модули слайдера\r\n// \t\t\t// для конкретного случая\r\n// \t\t\tmodules: [Navigation, Pagination, Autoplay],\r\n// \t\t\t//observer: true,\r\n// \t\t\t//observeParents: true,\r\n// \t\t\t//slidesPerView: 1,\r\n// \t\t\t//spaceBetween: 30,\r\n// \t\t\t//autoHeight: true,\r\n// \t\t\tspeed: 800,\r\n// \t\t\twatchOverflow: true,\r\n// \t\t\t//touchRatio: 0,\r\n// \t\t\t//simulateTouch: false,\r\n// \t\t\tloop: true,\r\n// \t\t\t//preloadImages: false,\r\n// \t\t\t//lazy: true,\r\n// \t\t\t// Эффекты\r\n// \t\t\t//effect: 'fade',\r\n// \t\t\t// autoplay: {\r\n// \t\t\t// \tdelay: 6000,\r\n// \t\t\t// \tdisableOnInteraction: false,\r\n// \t\t\t// },\r\n// \t\t\t// Пагинация\r\n\t\t\t\r\n// \t\t\t// pagination: {\r\n// \t\t\t// \tel: '.controll-knife-slider__dots',\r\n// \t\t\t// \tclickable: true,\r\n// \t\t\t// \tdynamicBullets: true\r\n// \t\t\t// },\r\n\t\t\t\r\n\r\n// \t\t\t// Скроллбар\r\n// \t\t\t/*\r\n// \t\t\tscrollbar: {\r\n// \t\t\t\tel: '.swiper-scrollbar',\r\n// \t\t\t\tdraggable: true,\r\n// \t\t\t},\r\n// \t\t\t*/\r\n\r\n// \t\t\t// Кнопки \"влево/вправо\"\r\n// \t\t\t// navigation: {\r\n// \t\t\t// \tprevEl: '.swiper-button-prev',\r\n// \t\t\t// \tnextEl: '.swiper-button-next',\r\n// \t\t\t// },\r\n\r\n// \t\t\t// Брейкпоинты\r\n\t\t\t\r\n// \t\t\tbreakpoints: {\r\n// \t\t\t\t320: {\r\n// \t\t\t\t\tslidesPerView: 1,\r\n// \t\t\t\t\tspaceBetween: 70,\r\n// \t\t\t\t},\r\n// \t\t\t\t// 768: {\r\n// \t\t\t\t// \tslidesPerView: 2,\r\n// \t\t\t\t// \tspaceBetween: 20,\r\n// \t\t\t\t// },\r\n// \t\t\t\t// 500: {\r\n// \t\t\t\t// \tslidesPerView: 3,\r\n// \t\t\t\t// \tspaceBetween: 20,\r\n// \t\t\t\t// },\r\n// \t\t\t\t1075: {\r\n// \t\t\t\t\tslidesPerView: 2,\r\n// \t\t\t\t\tspaceBetween: 30,\r\n// \t\t\t\t},\r\n// \t\t\t},\r\n\t\t\t\r\n// \t\t\t// События\r\n// \t\t\t// on: {\r\n// \t\t\t// \t// init: function (swiper) {\r\n\t\t\t\t\t\r\n// \t\t\t// \t// }\r\n// \t\t\t// }\r\n// \t\t});\r\n// \t}\r\n// }\r\n// Скролл на базе слайдера (по классу swiper_scroll для оболочки слайдера)\r\nfunction initSlidersScroll() {\r\n\tlet sliderScrollItems = document.querySelectorAll('.swiper_scroll');\r\n\tif (sliderScrollItems.length > 0) {\r\n\t\tfor (let index = 0; index < sliderScrollItems.length; index++) {\r\n\t\t\tconst sliderScrollItem = sliderScrollItems[index];\r\n\t\t\tconst sliderScrollBar = sliderScrollItem.querySelector('.swiper-scrollbar');\r\n\t\t\tconst sliderScroll = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](sliderScrollItem, {\r\n\t\t\t\tobserver: true,\r\n\t\t\t\tobserveParents: true,\r\n\t\t\t\tdirection: 'vertical',\r\n\t\t\t\tslidesPerView: 'auto',\r\n\t\t\t\tfreeMode: {\r\n\t\t\t\t\tenabled: true,\r\n\t\t\t\t},\r\n\t\t\t\tscrollbar: {\r\n\t\t\t\t\tel: sliderScrollBar,\r\n\t\t\t\t\tdraggable: true,\r\n\t\t\t\t\tsnapOnRelease: false\r\n\t\t\t\t},\r\n\t\t\t\tmousewheel: {\r\n\t\t\t\t\treleaseOnEdges: true,\r\n\t\t\t\t},\r\n\t\t\t});\r\n\t\t\tsliderScroll.scrollbar.updateSize();\r\n\t\t}\r\n\t}\r\n}\r\n\r\nwindow.addEventListener(\"load\", function (e) {\r\n\t// Запуск инициализации слайдеров\r\n\tinitSliders();\r\n\t// Запуск инициализации скролла на базе слайдера (по классу swiper_scroll)\r\n\t//initSlidersScroll();\r\n});\r\n\r\n\n\n//# sourceURL=webpack://rock/./src/js/modules/sliders.js?");
